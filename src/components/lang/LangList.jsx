...
formData.append('q', encode(ideogram.get('text')));
  ...
  render() {
    ...
    return (
      <div>
        ...
        {(searched !== '' || randomIndex !== null) && (
          searched !== '' ? ideogramList.filter(ideogram => ideogram.get('text') === searched).map((ideogram, index) => (
            <SimpleCard
            ...
            isEditing={displayEdition}
            character={ideogramList.get(randomIndex)}
