...
class Stats extends React.Component {
  ...
  render() {
    const { valueList, dataList, tempList, loading, startLoading } = this.state;
    ...
    return (
      <div>
        ...
        {startLoading && <div className={classes.title}><CircularProgress /></div>}
